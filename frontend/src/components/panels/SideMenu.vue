<template>
    <nav :class="MenuVisible ? 'visible' : ''">
        ...
        <div id="actions">
            <button v-if="!IsDeporte" :disabled="!canWizz" @click="addWizz" v-tooltip="'Wizz'"><img src="../../assets/msn_wizz.png" alt="wizz"/></button>
            <button v-if="isStarted && !IsDeporte" :disabled="!canReroll" @click="reroll" v-tooltip="'Re-piocher'"><img src="../../assets/reroll.png" alt="Reroll"/></button>
        </div>
